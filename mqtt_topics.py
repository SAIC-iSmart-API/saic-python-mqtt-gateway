...
CLIMATE_HEATED_SEATS_FRONT_LEFT_LEVEL_SET = CLIMATE_HEATED_SEATS_FRONT_LEFT_LEVEL + '/' + SET_SUFFIX
CLIMATE_HEATED_SEATS_FRONT_RIGHT_LEVEL = CLIMATE + '/heatedSeatsFrontRightLevel'
CLIMATE_HEATED_SEATS_FRONT_RIGHT_LEVEL_SET = CLIMATE_HEATED_SEATS_FRONT_RIGHT_LEVEL + '/' + SET_SUFFIX
...
DRIVETRAIN_BATTERY_HEATING_SCHEDULE_SET = DRIVETRAIN_BATTERY_HEATING_SCHEDULE + '/' + SET_SUFFIX
